...
if "__main__" == __name__:
    ...
    torch.save(efficientnet.state_dict(), "./models/efficientnetv2s/efficientnetv2s_tl.pth")
    #efficientnet.load_state_dict(torch.load("./models/efficientnetv2s/efficientnetv2s_tl.pth",  weights_only=True))
    ...
    torch.save(convnext_t.state_dict(), "./models/convnext_tiny/convnext_t.pth")
    #convnext_t.load_state_dict(torch.load("./models/convnext_tiny/convnext_t.pth",  weights_only=True))
